---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web, mobile, and desktop. Automatically load this skill whenever requested to: build a website, create a UI, design a landing page, build a dashboard, create a web app, improve an existing frontend, implement a Figma/design reference, make UI/UX decisions, or review/refine visual component styling, typography, color, layout, accessibility, and animations. Searchable dataset: 79 styles, 192 product palettes, 74 font pairings, 119 UX guidelines, 105 icons, 17 GSAP presets, 25 chart types, and 22 stacks."
---
